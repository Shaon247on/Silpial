...
import type { UpdateProfileResponse, UpdatePasswordResponse } from '@/types/profile.type';
...
export async function updatePasswordAction(
  ...
  try {
    ...
    const ax = err as { response?: { data?: { detail?: string; message?: string; current_password?: string[] } } };
    const msg =
